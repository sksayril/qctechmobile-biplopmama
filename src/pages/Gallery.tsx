    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white pt-16">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              <Camera className="w-8 h-8 text-green-500 mr-3" />
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                      ...
                      <p className="text-green-400 text-sm mt-2">{image.date}</p>
                    </div>
                  </div>
                  <motion.div 
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <button
                  className="absolute left-4 text-white hover:text-green-500 transition-colors"
                ...
                />
                <button
                  className="absolute right-4 text-white hover:text-green-500 transition-colors"
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-green-400">{selectedImage.date}</span>
                </div>
                <p className="text-gray-300 mb-2">{selectedImage.description}</p>
                <p className="text-green-400 text-sm">{selectedImage.category}</p>
              </motion.div>
            </motion.div>
          </motion.div>
        )}
